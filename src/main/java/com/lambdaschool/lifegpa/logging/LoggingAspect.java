package com.lambdaschool.lifegpa.logging;
...
{
    @Around(value = "@within(com.lambdaschool.lifegpa.logging.Loggable) || @annotation(com.lambdaschool.lifegpa.logging.Loggable)")
